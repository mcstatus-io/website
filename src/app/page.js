		...
		<>
			...
			<Container>
				...
				<section>
					...
					<p className="mb-3 leading-7">Our service offers many features that others do not, such as raw, clean, or HTML formats of many values like the MOTD, version name, and sample player names. We also reduced the cache duration of every status down to only 1 minute. Our service also fully supports the query protocol on top of the status protocol. It is also entirely possible to get a server&apos;s status information just using query information.</p>
