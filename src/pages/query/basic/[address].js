...
export default function Status() {
	...
	useEffect(() => (async () => {
		...
		try {
			const result = await fetch(`${config.apiHost}/query/basic/${query.address}`);
									...
									? <>
										<table className="table is-fullwidth is-hoverable">
											<tbody>
												...
												<tr>
													<th className={style.label}>Game Type</th>
													<td>{result.response.game_type}</td>
												</tr>
												<tr>
													<th className={style.label}>Map Name</th>
													<td>{result.response.map}</td>
												</tr>
												<tr>
												...
												}
												{
													debug
														? <tr>
															<th className={style.label}>Host IP</th>
															<td>{result.response.host_ip}</td>
														</tr>
														: null
												}
												{
													debug
														? <tr>
															<th className={style.label}>Host Port</th>
															<td>{result.response.host_port}</td>
														</tr>
														: null
												}
											</tbody>
