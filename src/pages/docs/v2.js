...
export default function DocumentationV2() {
	return (
		<DocumentationLayout version="v2">
			...
			<h2 className="title is-header" id="overview">
			...
			<h2 className="title is-header mt-6 mb-3" id="java-status">
			...
			<h2 className="title is-header mt-6 mb-3" id="bedrock-status">
			...
			<h2 className="title is-header mt-6 mb-3" id="icon">
