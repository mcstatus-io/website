							...
							</div>
							{
								data.showAPIUsage
									? <div className="p-4 border-t border-t-neutral-300 dark:border-t-neutral-700">
										...
										<p className="mt-3">Learn more about this response by viewing it in the <Link href="/docs#java-status" className="text-blue-500 hover:text-blue-400 transition-colors duration-150">API documentation</Link>.</p>
									</div>
									: null
							}
						</div>
