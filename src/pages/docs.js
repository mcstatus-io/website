			...
			<div className="container mx-auto my-12 lg:my-24 px-4">
				<div className="flex flex-col-reverse lg:flex-row">
					<div className="lg:basis-[75%]">
						...
						<Ad className="mt-4" />
						<h2 className="text-4xl font-black mt-12" id="overview">Overview</h2>
						...
						<h3 className="text-2xl font-black mt-12" id="standards">Standards</h3>
						...
						<h3 className="text-2xl font-black mt-12" id="cache">Cache</h3>
						...
						<h3 className="text-2xl font-black mt-12" id="supported">Supported Versions</h3>
						...
						<h2 className="text-4xl font-black mt-12" id="routes">Routes</h2>
						<h3 className="text-2xl font-black mt-6" id="java-status">Java Status</h3>
						<p className="mt-3">
						...
						<h3 className="text-2xl font-black mt-12" id="bedrock-status">Bedrock Status</h3>
						<p className="mt-3">
							<span className="bg-green-500 rounded px-2 py-1 text-xs">GET</span>
						...
						<h3 className="text-2xl font-black mt-12" id="icon">Icon</h3>
						<p className="mt-3">
							<span className="bg-green-500 rounded px-2 py-1 text-xs">GET</span>
							<code className="ml-2">https://api.mcstatus.io/v2/icon/&lt;address&gt;</code>
						</p>
